...
class Agent:
    ...
    def get_state(self, game):
        ...
        # only one of the following 4 will be true (current direction)
        dir_l = game.direction == Direction.LEFT
        dir_r = game.direction == Direction.RIGHT
        dir_u = game.direction == Direction.UP
        dir_d = game.direction == Direction.DOWN

        # state is an array with 11 values
        state = [
            # Danger straight
        ...
        return np.array(state, dtype=int)  # dtype converts all the boolean into 0 or 1
